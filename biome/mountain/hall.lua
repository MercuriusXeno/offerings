...
RegisterSpawnFunction(0xff0a17a0, "offering_spawn_mountain_hall_target_altar")
RegisterSpawnFunction(0xff6a17a9, "offering_spawn_mountain_hall_offer_altar")
local old_init = init
...
function offering_spawn_mountain_hall_target_altar(x, y)
  EntityLoad("mods/offerings/entity/target_altar.xml", x, y - 5)
end

function offering_spawn_mountain_hall_offer_altar(x, y)
